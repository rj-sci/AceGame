...
namespace game
{
	LaserGameObject::LaserGameObject(const glm::vec3& position, GLuint texture, GLint num_elements, GameObject* p) : GameObject(position, texture, num_elements, true, 0.25)
	{
		target_ = p;
		rotation_ = 0.0f;
		scale_ = 1.0 / 2;
